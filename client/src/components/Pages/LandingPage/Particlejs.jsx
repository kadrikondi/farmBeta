      ...
      <section>
        ...
        <div className="pSection">
          ...
          <div style={{ margin: "10px", opacity: "1!important" }}>
            ...
            <Link to="/signin">
              {" "}
              <button className="btn btn-white">Signin</button>
            </Link>
          </div>
          ...
          <p className="text-left">
            DEVELOPE BY IDRIS ABDULKADRI IN PARTIAL FULFILLMENT OF THE
            REQUIREMENTS FOR THE AWARD OF THE BACHELOR OF SCIENCE (HONOURS)
