...
{/* <!--Form with header--> */}
<div className="card mt-3" id="signup">
    <div className="card-body">
       ...
       <div class="md-form">
                    ...
                    <div class="md-form">
                        ...
                        <select className="form-control" value={this.state.farming} onChange={this.handleFarming}>
                            <option>--Type of Farming--</option>
   ...
   (<div className="alert alert-danger"id="info">{this.state.info}</div>)} 
        ...
        <div className="text-center">
            ...
            <button className="btn btn-green mdi mdi-account-plus" onClick={this.handleSubmit}> &nbsp;Sign up  
